    ...
    switch (datePickerDateOrder) {
      case DatePickerDateOrder.mdy:
        ...
        if (widget.hideDay == true) {
          pickerBuilders.removeAt(1);
          columnWidths.removeAt(1);
        }
        break;
      ...
      case DatePickerDateOrder.ymd:
        ...
        if (widget.hideDay == true) {
          pickerBuilders.removeAt(2);
          columnWidths.removeAt(2);
        }
        break;
...
class _CupertinoTimerPickerState extends State<CupertinoTimerPicker> {
  ...
  void _measureLabelMetrics() {
    ...
    if (widget.mode != CupertinoTimerPickerMode.ms) hourLabelWidth = _measureLabelsMaxWidth(localizations.timerPickerHourLabels, textStyle);

    if (widget.mode != CupertinoTimerPickerMode.hm) secondLabelWidth = _measureLabelsMaxWidth(localizations.timerPickerSecondLabels, textStyle);
  }
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        switch (widget.mode) {
          case CupertinoTimerPickerMode.hm:
            ...
            if (hourColumnStartPadding < _kTimerPickerMinHorizontalPadding) hourColumnStartPadding = _kTimerPickerMinHorizontalPadding;

            double minuteColumnEndPadding = pickerColumnWidth - minuteLabelContentWidth - _kTimerPickerHalfColumnPadding;
            if (minuteColumnEndPadding < _kTimerPickerMinHorizontalPadding) minuteColumnEndPadding = _kTimerPickerMinHorizontalPadding;
          ...
          case CupertinoTimerPickerMode.ms:
            ...
            if (secondColumnEndPadding < _kTimerPickerMinHorizontalPadding) secondColumnEndPadding = _kTimerPickerMinHorizontalPadding;

            double minuteColumnStartPadding = pickerColumnWidth - minuteLabelContentWidth - _kTimerPickerHalfColumnPadding;
            if (minuteColumnStartPadding < _kTimerPickerMinHorizontalPadding) minuteColumnStartPadding = _kTimerPickerMinHorizontalPadding;
